...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "/home/panda/IdeaProjects/multiplatform-base64/build/js/packages/multiplatform-base64-js-legacy-test/node_modules",
  "files": [
    "/home/panda/IdeaProjects/multiplatform-base64/build/js/packages/multiplatform-base64-js-legacy-test/adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace("/home/panda/IdeaProjects/multiplatform-base64/build/js", '');;
        console.log(msg);
    };
